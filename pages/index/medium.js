...
var i, a, n = require("../../utils/autoimage.js");
...
Page((a = {
    data: (i = {
        ...
        indexSelect: 0,
        imghidden: !1
    }, e(i, "imghidden", !1), e(i, "play", !1), e(i, "p", 0), i),
    onLoad: function(e) {
        t(this);
        var i = this;
        wx.getSystemInfo({
    ...
    formSubmit: function(e) {
        var t = this.data.age[e.detail.value.age].value, i = {
            ...
            medium: "少儿英语培训机构排名(6-12)",
            title: "少儿英语培训机构排名(6-12)"
        };
        wx.request({
    ...
    videoPlay: function(e) {
        this.videoContext && this.videoContext.pause(), this.videoContext = wx.createVideoContext(e.currentTarget.id);
    },
...
}), e(a, "clickhome", function() {
    console.log("点击title"), wx.navigateBack({
        delta: 2
    });
}), e(a, "bindPickerChange", function(e) {
    this.setData({
